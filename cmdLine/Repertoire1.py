...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', nargs=1,action=customAction,dest="ccfxPath",model=app_model,
                        help="ccFinder input format")
    parser.add_argument('-b', nargs=1,action=customAction,dest="token",model=app_model,
                        help="ccFinder token size")
